...
.. toctree::
   ...
   source/content/combine_dmr_deg2block
   source/content/filter_blocks
   source/content/collect_gene_names4blocks
   source/content/check_block_gene_inTAD
   source/content/dds_geneRanking
   source/content/go_pathway_analysis4out_blocks_gene
   source/content/find_enhancer_target_genes
   source/content/chromSegment_test4blocks
   source/content/dTarget_methy_vs_express
   source/content/plot_mr_vs_exp
   source/content/plot_tss_enhancer_mrs
   source/content/filterDEG4bpb3
   source/content/preprocess
   source/content/demoFL
   source/content/demoHAP1
   source/content/demoRAT
   source/content/demoFLMR
